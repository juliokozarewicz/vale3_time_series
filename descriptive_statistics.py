...
class Time_serie_level:
    ...
    def acf_pacf_plot(self):
        ...
        # plot
        acf = plot_acf(self.data_endog.values.squeeze(),
                       lags = len(self.data_endog) / 3,
                       use_vlines = True,
        ...
        acf = plot_pacf(self.data_endog.values.squeeze(),
                       lags = len(self.data_endog) / 3,
                       use_vlines = True,
